...
public class User implements UserDetails
{
    ...
    public Collection<? extends GrantedAuthority> getAuthorities()
    {
        ...
        List<SimpleGrantedAuthority> simpleAuthoritise = new ArrayList<>();
        for (GrantedAuthority authority : this.authorities)
        {
            simpleAuthoritise.add(new SimpleGrantedAuthority(authority.getAuthority()));
        }

        return simpleAuthoritise;
    }
